...
from handlers.post_handler import PostCommentsHandler, CommentEditHandler, CommentDeleteHandler, ShowCommentsHandler, HideCommentsHandler
...
app = webapp2.WSGIApplication([
    ...
    ('/blog/([0-9]+)/comments', ShowCommentsHandler),
    ('/blog/([0-9]+)/comments/hide', HideCommentsHandler),
